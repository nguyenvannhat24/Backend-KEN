...
// Clone board từ template (yêu cầu đăng nhập) - đặt TRƯỚC các route :id để tránh xung đột
router.post('/clone/:templateId', authenticateAny, boardController.cloneBoard);
